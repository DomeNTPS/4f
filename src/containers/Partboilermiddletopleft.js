...
import Boilermiddletopleft from "../../Image/boiler/boilermidtopleft.svg";
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.containerbottomall}>
          ...
          >
            <Boilermiddletopleft height={400
            ...
            onPress = {
                () =>
                this.props.navigation.navigate("PartEllipse",{KKS:'10HAH20CT001 TT 001'})
              } >
                </ TouchableOpacity>
                </ View>
                < View style = {
            ...
            onPress = {
                () =>
                this.props.navigation.navigate("PartEllipse",{KKS:'10HAH20CT002 TT 002'})
              } >
                </ TouchableOpacity>
                </ View>
                < View style = {
            ...
            onPress = {
                () =>
                this.props.navigation.navigate("PartV",{KKS:'10HAH20CT003 TT 003'})
              } >
                </ TouchableOpacity>
                </ View>
                < View style = {
            ...
            onPress = {
                () =>
                this.props.navigation.navigate("PartV",{KKS:'10HAH20CT004 TT 004'})
              } >
                </ TouchableOpacity>
                </ View>
          </ScrollView>
