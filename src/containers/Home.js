    ...
    return (
      <View style={styles.container}>
        <View style={styles.containertop}>
          ...
          <TouchableOpacity title="Scan" onPress={() => this.props.navigation.navigate('ScanScreen')}>
            <Image
              style={{
                paddingRight: 20,
                paddingTop: 30,
        ...
        <View style={styles.containerbottom}>
          <TouchableOpacity
            ...
            title="Scan"
            alignItems="center"
            onPress={() => this.props.navigation.navigate('Partboiler', { KKS1: kks1 })}
          >
            <Text style={{ marginTop: 5, alignSelf: 'center', fontSize: 30, fontWeight: 'bold' }}>
              Factory {remove_last_character(kks1)}
            </Text>
            <Image
              style={{
                marginTop: 20,
